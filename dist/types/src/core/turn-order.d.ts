...
export declare function SetActivePlayersEvent(state: State, _playerID: PlayerID, arg: ActivePlayersArg | PlayerID[]): {
    ctx: {
        ...
        player?: import("../plugins/plugin-player").PlayerAPI;
 ...
 */
export declare function InitTurnOrderState(G: any, ctx: Ctx, turn: TurnConfig): Ctx;
/**
 ...
 */
export declare function UpdateTurnOrderState(G: any, ctx: Ctx, turn: TurnConfig, endTurnArg?: true | {
    remove: any;
    next: string;
}): {
    endPhase: boolean;
