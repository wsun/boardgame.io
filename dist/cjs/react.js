...
var socketio = require('./socketio-c79c3c27.js');
...
var _LobbyConnectionImpl = /*#__PURE__*/function () {
  function _LobbyConnectionImpl(_ref) {
    ...
    reducer._classCallCheck(this, _LobbyConnectionImpl);
  ...
  reducer._createClass(_LobbyConnectionImpl, [{
    key: "_baseUrl",
    ...
    value: async function refresh() {
      try {
        ...
        var _iterator = reducer._createForOfIteratorHelper(json),
            _step;
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            var _iterator2 = reducer._createForOfIteratorHelper(gameJson.rooms),
                _step2;
    ...
    value: function _getGameInstance(gameID) {
      var _iterator3 = reducer._createForOfIteratorHelper(this.rooms),
          _step3;
    ...
    value: function _getGameComponents(gameName) {
      var _iterator4 = reducer._createForOfIteratorHelper(this.gameComponents),
          _step4;
    ...
    value: function _findPlayer(playerName) {
      var _iterator5 = reducer._createForOfIteratorHelper(this.rooms),
          _step5;
    ...
    value: async function leave(gameName, gameID) {
      try {
        ...
        var _iterator6 = reducer._createForOfIteratorHelper(inst.players),
            _step6;
...
var LobbyLoginForm = /*#__PURE__*/function (_React$Component) {
  reducer._inherits(LobbyLoginForm, _React$Component);

  var _super = reducer._createSuper(LobbyLoginForm);

  function LobbyLoginForm() {
    var _this;

    reducer._classCallCheck(this, LobbyLoginForm);
    ...
    reducer._defineProperty(reducer._assertThisInitialized(_this), "state", {
      playerName: _this.props.playerName,
      nameErrorMsg: ''
    });

    reducer._defineProperty(reducer._assertThisInitialized(_this), "onClickEnter", function () {
      if (_this.state.playerName === '') return;

      _this.props.onEnter(_this.state.playerName);
    });

    reducer._defineProperty(reducer._assertThisInitialized(_this), "onKeyPress", function (event) {
      if (event.key === 'Enter') {
        _this.onClickEnter();
      }
    });

    reducer._defineProperty(reducer._assertThisInitialized(_this), "onChangePlayerName", function (event) {
  ...
  reducer._createClass(LobbyLoginForm, [{
    key: "render",
    value: function render() {
...
reducer._defineProperty(LobbyLoginForm, "propTypes", {
  playerName: PropTypes.string,
  onEnter: PropTypes.func.isRequired
});

reducer._defineProperty(LobbyLoginForm, "defaultProps", {
  playerName: ''
});

var LobbyRoomInstance = /*#__PURE__*/function (_React$Component) {
  reducer._inherits(LobbyRoomInstance, _React$Component);

  var _super = reducer._createSuper(LobbyRoomInstance);

  function LobbyRoomInstance() {
    var _this;

    reducer._classCallCheck(this, LobbyRoomInstance);
    ...
    reducer._defineProperty(reducer._assertThisInitialized(_this), "_createSeat", function (player) {
      return player.name || '[free]';
    });

    reducer._defineProperty(reducer._assertThisInitialized(_this), "_createButtonJoin", function (inst, seatId) {
    ...
    reducer._defineProperty(reducer._assertThisInitialized(_this), "_createButtonLeave", function (inst) {
      return /*#__PURE__*/React.createElement("button", {
    ...
    reducer._defineProperty(reducer._assertThisInitialized(_this), "_createButtonPlay", function (inst, seatId) {
      return /*#__PURE__*/React.createElement("button", {
    ...
    reducer._defineProperty(reducer._assertThisInitialized(_this), "_createButtonSpectate", function (inst) {
      return /*#__PURE__*/React.createElement("button", {
    ...
    reducer._defineProperty(reducer._assertThisInitialized(_this), "_createInstanceButtons", function (inst) {
  ...
  reducer._createClass(LobbyRoomInstance, [{
    key: "render",
    value: function render() {
...
reducer._defineProperty(LobbyRoomInstance, "propTypes", {
...
var LobbyCreateRoomForm = /*#__PURE__*/function (_React$Component) {
  reducer._inherits(LobbyCreateRoomForm, _React$Component);

  var _super = reducer._createSuper(LobbyCreateRoomForm);

  function LobbyCreateRoomForm(props) {
    var _this;

    reducer._classCallCheck(this, LobbyCreateRoomForm);
    ...
    reducer._defineProperty(reducer._assertThisInitialized(_this), "_createGameNameOption", function (game, idx) {
    ...
    reducer._defineProperty(reducer._assertThisInitialized(_this), "_createNumPlayersOption", function (idx) {
      return /*#__PURE__*/React.createElement("option", {
        key: 'num-option-' + idx,
        value: idx
      }, idx);
    ...
    reducer._defineProperty(reducer._assertThisInitialized(_this), "_createNumPlayersRange", function (game) {
      return reducer._toConsumableArray(new Array(game.maxPlayers + 1).keys()).slice(game.minPlayers);
    });

    reducer._defineProperty(reducer._assertThisInitialized(_this), "onChangeNumPlayers", function (event) {
      _this.setState({
        numPlayers: Number.parseInt(event.target.value)
      });
    });

    reducer._defineProperty(reducer._assertThisInitialized(_this), "onChangeSelectedGame", function (event) {
    ...
    reducer._defineProperty(reducer._assertThisInitialized(_this), "onClickCreate", function () {
      _this.props.createGame(_this.props.games[_this.state.selectedGame].game.name, _this.state.numPlayers);
    });

    var _iterator = reducer._createForOfIteratorHelper(props.games),
        _step;
  ...
  reducer._createClass(LobbyCreateRoomForm, [{
    key: "render",
    value: function render() {
      var _this2 = this;
...
reducer._defineProperty(LobbyCreateRoomForm, "propTypes", {
...
var Lobby = /*#__PURE__*/function (_React$Component) {
  reducer._inherits(Lobby, _React$Component);

  var _super = reducer._createSuper(Lobby);

  function Lobby(_props) {
    var _this;

    reducer._classCallCheck(this, Lobby);
    ...
    reducer._defineProperty(reducer._assertThisInitialized(_this), "_createConnection", function (props) {
    ...
    reducer._defineProperty(reducer._assertThisInitialized(_this), "_updateCredentials", function (playerName, credentials) {
    ...
    reducer._defineProperty(reducer._assertThisInitialized(_this), "_updateConnection", async function () {
      await _this.connection.refresh();

      _this.forceUpdate();
    });

    reducer._defineProperty(reducer._assertThisInitialized(_this), "_enterLobby", function (playerName) {
      _this.setState({
    ...
    reducer._defineProperty(reducer._assertThisInitialized(_this), "_exitLobby", async function () {
    ...
    reducer._defineProperty(reducer._assertThisInitialized(_this), "_createRoom", async function (gameName, numPlayers) {
      try {
    ...
    reducer._defineProperty(reducer._assertThisInitialized(_this), "_joinRoom", async function (gameName, gameID, playerID) {
      try {
    ...
    reducer._defineProperty(reducer._assertThisInitialized(_this), "_leaveRoom", async function (gameName, gameID) {
      try {
    ...
    reducer._defineProperty(reducer._assertThisInitialized(_this), "_startGame", function (gameName, gameOpts) {
    ...
    reducer._defineProperty(reducer._assertThisInitialized(_this), "_exitRoom", function () {
      _this.setState({
        phase: LobbyPhases.LIST,
        runningGame: null
      });
    ...
    reducer._defineProperty(reducer._assertThisInitialized(_this), "_getPhaseVisibility", function (phase) {
      return _this.state.phase !== phase ? 'hidden' : 'phase';
    });

    reducer._defineProperty(reducer._assertThisInitialized(_this), "renderRooms", function (rooms, playerName) {
...
reducer._defineProperty(Lobby, "propTypes", {
...
reducer._defineProperty(Lobby, "defaultProps", {
  debug: false,
